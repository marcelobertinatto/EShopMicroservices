namespace Order.Application.Orders.Commands.CreateOrder
{
        ...
        : ICommandHandler<CreateOrderCommand, CreateOrderResult>
    {
        ...
        {
            var shippingAddress = Domain.ValueObjects.Address.Of(orderDto.ShippingAddress.FirstName, 
            ...
            var billingAddress = Domain.ValueObjects.Address.Of(orderDto.BillingAddress.FirstName, 
            ...
            var newOder = Domain.Models.Order.Create(
            ...
            {
                newOder.Add(ProductId.Of(orderItemDto.ProductId),
